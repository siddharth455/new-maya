...
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/evs-3.webp);">
        <div class="container">
            ...
            <div class="col-xl-9 col-lg-8">
                <div class="course-left-wrap mr-40">
                    <div class="apply-area">
                        <img src="assets/uploads/evs-3.webp" alt="">
                                ...
                                <div class="over-view-list">
                                    ...
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>Bachelor’s degree in Environmental Science or any relevant science discipline (Botany, Zoology, Chemistry, Biotechnology, Microbiology, etc.) with minimum 50% aggregate marks.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                ...
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-recent-course-wrap mb-40">
                        ...
                        <div class="over-view-list">
                            ...
                            <div class="sin-over-view-list">
                                ...
                                <div class="course-list-content">
                                    <p>Advanced study of ecology, environmental chemistry, biodiversity, and sustainable resource management.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Hands-on learning through fieldwork, field surveys, pollution monitoring, sampling techniques, and GIS applications.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Skill development in EIA, environmental auditing, data analysis, laboratory testing, and research methodology.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Opportunities for internships, research projects, workshops, seminars, and preparation for Ph.D. studies.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="over-view-list">
                        ...
                        <div class="sin-over-view-list">
                            ...
                            <div class="course-list-content">
                                <p>Environmental Scientist / Researcher – Work in research institutions, environmental labs, and universities.</p>
                            </div>
                        </div>
                        <div class="sin-over-view-list">
                            <div class="course-list-icon">
                            ...
                            <div class="course-list-content">
                                <p>Environmental Consultant / Sustainability Specialist – Roles in industries, corporates, and consulting firms.</p>
                            </div>
                        </div>
                        <div class="sin-over-view-list">
                            <div class="course-list-icon">
                            ...
                            <div class="course-list-content">
                                <p>Pollution Control Officer / Environmental Analyst – Work with government pollution control boards and monitoring agencies.</p>
                            </div>
                        </div>
                        <div class="sin-over-view-list">
                            <div class="course-list-icon">
                            ...
                            <div class="course-list-content">
                                <p>Ecologist / Wildlife & Conservation Officer – Opportunities in forestry, wildlife conservation, biodiversity management, and NGOs.</p>
                            </div>
                        </div>
                        <div class="sin-over-view-list">
                            <div class="course-list-icon">
                            ...
                            <div class="course-list-content">
                                <p>GIS & Remote Sensing Analyst – Employment in GIS companies, mapping agencies, and environmental planning firms.</p>
                            </div>
                        </div>
                        <div class="sin-over-view-list">
                            <div class="course-list-icon">
                            ...
                            <div class="course-list-content">
                                <p>Teaching & Academic Roles – Lecturer or professor roles in colleges and universities (with NET/Ph.D.).</p>
                            </div>
                        </div>
                    </div>
