...
<div class="course-area bg-img pt-40">
    <div class="container">
        ...
        <div class="single-course">
                            ...
                            <div class="single-course">
                                <div class="course-img">
                                    <a href="m.tech-mechanical-engineering.php"><img class="animated" src="assets/uploads/b.tech-mechanical.webp" alt=""></a>
                                </div>
                                <div class="course-content">
                                <h4><a href="m.tech-mechanical-engineering.php">B.Tech in Mechanical Engineering</a></h4>
                                <p>The M.Tech Mechanical Engineering is a two-year program focusing on advanced design, thermal sciences, and manufacturing technologies.</p>
                                </div>
                                <div class="course-position-content">
                                    <div class="credit-duration-wrap">
                                        <div class="sin-credit-duration">
