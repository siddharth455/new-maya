    ...
    <div class="container">
        ...
        <div class="tab-content jump">
            <div class="tab-pane active" id="course-categorie-1">
                <div class="course-slider-active-2 nav-style-1 owl-carousel">
                    <div class="course-categorie-bundle">
                        <div class="single-course mb-30">
                            <div class="course-img">
                                <a href="course-details.php"><img src="assets/img/course/course-5.jpg" alt=""></a>
                            </div>
                            <div class="course-content course-content-2">
                                <h4><a href="course-details.php">Courses Title Here</a></h4>
                                <p>Veniam, nisi ut aliquiptempor incid idunt ut labore et dolore. </p>
                            </div>
                        </div>
                        <div class="single-course mb-30">
                            <div class="course-img">
                                <a href="course-details.php"><img src="assets/img/course/course-9.jpg" alt=""></a>
                    ...
                    <div class="course-categorie-bundle">
                        <div class="single-course mb-30">
                            <div class="course-img">
                                <a href="course-details.php"><img src="assets/img/course/course-6.jpg" alt=""></a>
                            </div>
                            <div class="course-content course-content-2">
                        ...
                        <div class="single-course mb-30">
                            <div class="course-img">
                                <a href="course-details.php"><img src="assets/img/course/course-10.jpg" alt=""></a>
                            </div>
                            <div class="course-content course-content-2">
                                <h4><a href="course-details.php">Grphic Design & Multimedia</a></h4>
                                <p>Veniam, nisi ut aliquiptempor incid idunt ut labore et dolore. </p>
                    ...
                    <div class="course-categorie-bundle">
                        <div class="single-course mb-30">
                            <div class="course-img">
                                <a href="course-details.php"><img src="assets/img/course/course-7.jpg" alt=""></a>
                            </div>
                            <div class="course-content course-content-2">
                        ...
                        <div class="single-course mb-30">
                            <div class="course-img">
                                <a href="course-details.php"><img src="assets/img/course/course-11.jpg" alt=""></a>
                            </div>
                            <div class="course-content course-content-2">
                                <h4><a href="course-details.php">Computer Engineering</a></h4>
                                <p>Veniam, nisi ut aliquiptempor incid idunt ut labore et dolore. </p>
                    ...
                    <div class="course-categorie-bundle">
                        <div class="single-course mb-30">
                            <div class="course-img">
                                <a href="course-details.php"><img src="assets/img/course/course-8.jpg" alt=""></a>
                                <span class="new-course">New Course</span>
                            </div>
                            <div class="course-content course-content-2">
                        ...
                        <div class="single-course mb-30">
                            <div class="course-img">
                                <a href="course-details.php"><img src="assets/img/course/course-12.jpg" alt=""></a>
                                <span class="new-course">New Course</span>
                            </div>
                            <div class="course-content course-content-2">
                                <h4><a href="course-details.php">Fashion & Technology</a></h4>
            ...
            <div class="view-all text-center mt-20">
                <a class="default-btn" href="course.php">VIEW ALL</a>
            </div>
        </div>
    </div>
</div>
